    ...
    <div>
        ...
        <section class="py-16 bg-secondary">
            <div class="max-w-6xl mx-auto px-8">
                <h2 class="text-3xl font-bold mb-8">Our Latest Works</h2>
                ...
                <div class="flex justify-center">
                    <a href="#" class="inline-flex items-center justify-center min-w-40 min-h-11 px-8 py-3 bg-button hover:bg-button-hover text-black border-2 font-semibold rounded-lg transition-colors">
                        Lihat Semua
                    </a>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 text-left">
                    ...
                    <div class="bg-primary rounded-lg shadow-md p-6">
                        ...
                        <p class="text-gray-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas,
                            doloremque?</p>
                        <a href="" class="inline-flex items-center justify-center min-w-40 min-h-11 mt-4 px-4 py-2 bg-button hover:bg-button-hover text-black border-2 font-semibold rounded-lg transition-colors w-full sm:w-auto text-center">Selengkapnya</a>
                    </div>
                    <!-- Service Item -->
                    <div class="bg-primary rounded-lg shadow-md p-6">
